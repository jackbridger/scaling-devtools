<template>
  <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
    ...
    <div class="mx-auto max-w-2xl lg:max-w-4xl">
      <img class="mx-auto h-12" :src="logoSrc" alt="" />
      <figure class="mt-10">
        <blockquote class="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
          <p>{{ testimonialText }}</p>
        </blockquote>
        <figcaption class="mt-10">
          <img class="mx-auto h-10 w-10 rounded-full" :src="imageSrc" alt="" />
...
export default {
  props: {
    logoSrc: {
      type: String,
      required: true,
      default: 'https://tailwindui.com/img/logos/workcation-logo-indigo-600.svg'
    },
    testimonialText: {
      type: String,
      required: true,
