      ...
      <div class="xl:grid xl:grid-cols-3 xl:gap-8">
        ...
        <!-- <div class="mt-10 xl:mt-0">
          ...
          <form class="mt-6 sm:flex sm:max-w-md">
            ...
            <input type="email" name="email-address" id="email-address" autocomplete="email" required="" class="w-full min-w-0 appearance-none rounded-md border-0 bg-white px-3 py-1.5 text-base text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-600 sm:w-64 sm:text-sm sm:leading-6 xl:w-full" placeholder="Enter your email" />
            <div class="mt-4 sm:ml-4 sm:mt-0 sm:flex-shrink-0">
              <button type="submit" class="flex w-full items-center justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-green-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-green-600">Subscribe</button>
            </div>
          </form>
        </div> -->
      </div>
...
const navigation = {
  ...
  social: [
    {
      name: 'X',
      href: 'https://x.com/scalingdevtools',
    ...
    {
      name: 'GitHub',
      href: 'https://github.com/jackbridger/scaling-devtools',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/channel/UCT0rU8tDYLnlOCLIk2nYQUg',
      icon: defineComponent({
        render: () =>
          h('svg', { fill: 'currentColor', viewBox: '0 0 24 24' }, [
            h('path', {
